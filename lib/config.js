...
const Config = function () {
  ...
  this.geoApiKey = getNPMConfig(['brave_google_api_key']) || getNPMConfig(['geo_api_key']) || 'AIzaSyAQfxPJiounkhOjODEO5ZieffeBv6yft2Q'
  this.geoApiEndpoint = getNPMConfig(['brave_google_api_endpoint']) || 'https://www.googleapis.com/geolocation/v1/geolocate?key='
...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    ...
    brave_google_api_key: this.geoApiKey,
    brave_google_api_endpoint: this.geoApiEndpoint,
...
Config.prototype.update = function (options) {
  ...
  if (options.brave_google_api_key) {
    this.geoApiKey = options.brave_google_api_key
  }

  if (options.brave_google_api_endpoint) {
    this.geoApiEndpoint = options.brave_google_api_endpoint
  }
